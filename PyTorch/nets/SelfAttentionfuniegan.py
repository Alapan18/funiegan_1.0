...
class GeneratorFunieGAN(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=3):
        ...
        # attention layers
        self.attention1 = SelfAttention(256)  # After down3
        self.attention2 = SelfAttention(256)  # After up3
    ...
    def forward(self, x):
        ...
        d2 = self.down2(d1)
        d3 = self.down3(d2)
        d3 = self.attention1(d3)  # Apply attention after down3
        d4 = self.down4(d3)
        d5 = self.down5(d4)
        ...
        u2 = self.up2(u1, d3)
        u3 = self.up3(u2, d2)
        u3 = self.attention2(u3)  # Apply attention after up3
        u4 = self.up4(u3, d1)
